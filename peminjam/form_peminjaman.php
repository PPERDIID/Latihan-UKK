        ...
        <div class="content mt-3">
            <div class="card bg-success bg-gradient">
                <div class="card-body">
                    ...
                    <a href="http://localhost/digitallibrary/index.php?pesan=info_logout/logout.php" class="btn text-light">LOGOUT</a>
                </div>
            </div>
        </div>
        <div class="container">
            ...
            if(isset($_GET['return_id'])) {
                ...
                if ($conn->query($updateSql) === TRUE) {
                    echo "<p>Status peminjaman berhasil diperbarui.</p>";
                } else {
